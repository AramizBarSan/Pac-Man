//variables para funciones principales y marcadores 
var KEYDOWN = false;
var PAUSE = false;
var LOCK = false;
...
// iniciacion del juego o caratula 
...
//funcion ganar, cuando se gana y se prepara el sigueinet nivel
function win() { 
	if (isAvailableSound()) { 
		GROUP_SOUND.stop();
		BACK_SOUND.play();
	...
	setTimeout("prepareNextLevel()", 10000);
...
//funcion reiniciar o reinicoo del juego
function retry() { 
	stopTimes();
...
//muestra comentaroios del juego 
function ready() { 
	LOCK = true;
	message("ready!");
...
// aqui se aumenta el puntaje y se resta el numero de vida 
function startTimes() { 
